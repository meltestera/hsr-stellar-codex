  ...
  return (
    <>
      <div className="relative flex flex-col">
        <div className="h-full w-full bg-[url('/src/assets/Background_Stars.webp')] bg-cover bg-no-repeat py-40 sm:bg-[75%_center] lg:bg-[35%_center]">
          ...
          <div className="mx-auto max-w-screen-2xl">
            <div className="rounded-xl border-x border-x-skin-tone-darker text-skin-tone-light">
              <div className="relative min-h-[5535px] dark:bg-almost-black/60 xs:min-h-[6837px] sm:min-h-[6086px] sm:shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] md:min-h-[4850px] lg:min-h-[4902px] xl:min-h-[3666px]">
                <div className="space-y-16 overflow-x-hidden px-2 py-10 text-base sm:space-y-32 sm:px-4 sm:py-32 lg:px-16">
                  <div className="max-w-[200px] py-2 text-left">
                    <b className="font-poppins text-2xl xs:text-3xl sm:text-4xl lg:text-6xl">
                      Playable Characters
                    </b>
                  </div>
                  <CharacterFilterBar
